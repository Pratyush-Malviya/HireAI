...
if (layoutStart !== -1) {
    const returnStart = content.indexOf('  return (\n    <div className="min-h-screen', layoutStart);
    const pagesStart = content.indexOf('// --- Pages ---', returnStart);
    if (returnStart !== -1 && pagesStart !== -1) {
...
`;
        ...
        content = content.substring(0, returnStart) + newReturn + content.substring(pagesStart);
